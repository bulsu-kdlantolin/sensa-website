          ...
          >
            <div>
              <div className="mb-6 pb-4 border-b border-[#8A56FF]/30">
                ...
                <span className="text-xs font-mono font-bold uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-[#0A44FF] to-[#6AA2FF]">
                  Supported Features
                </span>
              </div>
                    ...
                    <div key={idx} className="group flex gap-4 items-start p-3 -mx-3 rounded-2xl transition-all duration-300 hover:bg-slate-500/5 cursor-default">
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 border transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 ${isDark
                            ? 'bg-gradient-to-br from-[#0A44FF]/20 to-[#6AA2FF]/20 text-[#0A44FF] border-[#0A44FF]/30 group-hover:border-[#0A44FF]/60 group-hover:shadow-[0_0_15px_rgba(10,68,255,0.3)]'
                            : 'bg-gradient-to-br from-[#0A44FF]/10 to-[#6AA2FF]/10 text-[#0A44FF] border-[#0A44FF]/20 group-hover:border-[#0A44FF]/50 group-hover:shadow-[0_0_15px_rgba(10,68,255,0.2)]'
                          }`}
                      >
                        <Icon size={20} />
                      </div>
                      <div>
                        <h4 className={`text-base font-bold mb-1 transition-colors duration-300 group-hover:text-[#0A44FF] ${isDark ? 'text-white' : 'text-slate-900'}`}>
                          {item.title}
                        </h4>

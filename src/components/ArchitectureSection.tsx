  ...
  const coreInfrastructure = [
    {
      ...
      items: [
        { name: 'Plasmo Framework', detail: 'Next-gen browser extension framework supporting Manifest V3, HMR, and modular component isolation.', Logo: PlasmoLogo, url: 'https://docs.plasmo.com/' },
        { name: 'React 18 & TypeScript', detail: 'Powers dynamic overlay UI components with strict type-safety and reactive state management.', Logo: ReactLogo, url: 'https://react.dev/' },
        { name: 'Tailwind CSS & Lucide', detail: 'Utility-first design system enforcing WCAG 2.1 AAA contrast compliance and vector icon sets.', Logo: TailwindLogo, url: 'https://tailwindcss.com/' },
      ],
    },
    {
      ...
      items: [
        { name: 'Render Cloud Hosting', detail: 'Cloud server hosting for Node.js WebSocket proxy with automated SSL, scaling, and low latency.', Logo: RenderCloudLogo, url: 'https://render.com/' },
        { name: 'Node.js & WebSocket Proxy', detail: 'Low-latency relay server streaming real-time audio buffers between Chrome client and Deepgram AI engine.', Logo: NodeLogo, url: 'https://nodejs.org/' },
      ],
    },
  ];
      ...
      apis: [
        {
          ...
          spec: 'v3.0 REST API',
          purpose: 'Executes real-time neural machine translation across 135+ supported languages via REST v3.0.',
          Logo: AzureLogo,
        ...
        },
        {
          ...
          spec: 'Nova-3 Model',
          purpose: 'Streams raw PCM audio over WebSockets to Nova-3 speech AI models for sub-second captioning.',
          Logo: DeepgramLogo,
        ...
        },
        {
          ...
          purpose: 'Dynamically loads accessible web typography (OpenDyslexic, Outfit, Inter) for live overlay rendering.',
          Logo: GoogleLogo,
      ...
      apis: [
        {
          ...
          purpose: 'Analyzes raw audio buffers via AudioContext and AnalyserNode to calculate decibel levels for safety warnings.',
          Logo: Radio,
        ...
        },
        {
          ...
          purpose: 'Captures real-time vocal inputs via webkitSpeechRecognition to trigger hands-free voice commands.',
          Logo: Mic,
        ...
        },
        {
          ...
          purpose: 'Converts highlighted text, ARIA landmarks, and webpage contents into synthetic audio output via SpeechSynthesisUtterance.',
          Logo: Volume2,
        ...
        },
        {
          ...
          purpose: 'Captures active tab media streams and routes audio via setSinkId to preserve local speaker playback.',
          Logo: Headphones,
        ...
        },
        {
          ...
          purpose: 'Monitors DOM tree mutations in real time to sync live text highlighting during speech synthesis.',
          Logo: Eye,
        ...
        },
        {
          name: 'WebSocket API',
          spec: 'new WebSocket',
          purpose: 'Establishes persistent full-duplex TCP connections for real-time binary audio streaming and caption sync.',
          Logo: Network,
      ...
      apis: [
        {
          ...
          purpose: 'Captures real-time raw PCM audio streams from active browser tab media playback.',
          Logo: ChromeTechLogo,
        ...
        },
        {
          ...
          purpose: 'Executes background Web Audio processing and persistent WebSocket streams within MV3 sandbox restrictions.',
          Logo: ChromeTechLogo,
        ...
        },
        {
          ...
          purpose: 'Persists user accessibility configurations locally on-device in memory without cloud dependency.',
          Logo: ChromeTechLogo,
        ...
        },
        {
          ...
          purpose: 'Programmatically injects content scripts, custom CSS filters, and accessibility overlays into host web pages.',
          Logo: ChromeTechLogo,
        ...
        },
        {
          ...
          purpose: 'Facilitates asynchronous inter-process communication (IPC) between background service worker, offscreen DOM, and content scripts.',
          Logo: ChromeTechLogo,
        ...
        },
        {
          ...
          purpose: 'Queries active tab states, manages tab audio lifecycle, and targets script execution per active session.',
          Logo: ChromeTechLogo,
